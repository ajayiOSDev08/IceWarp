...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // Ensure the persistent store is loaded
        ...
        if let _ = KeychainHelper.shared.getToken() {
            // If token exists, go directly to Channel screen
            guard let channelVC = storyboard.instantiateViewController(withIdentifier: "ChannelVC") as? ChannelViewController else { return }
